...
import com.hotel.service.RecensioniService;
...
public class RecensioniController {
    ...
    public ResponseEntity<Recensioni> getRecensioni(@PathVariable Long id) {
    ...
    public ResponseEntity<Void> deleteRecensioni(@PathVariable Long id) {
